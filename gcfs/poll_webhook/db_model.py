...
class Ulinc_campaign(Base):
    ...
    contacts = relationship('Contact', backref='ulinc_campaign', lazy=False)
...
class Contact(Base):
    ...
    ulinc_campaign_id = Column(String(20), nullable=False)
    internal_ulinc_campaign_id = Column(String(20), ForeignKey('ulinc_campaign.id'), nullable=False)
    firstname = Column(String(100), nullable=False)
    lastname = Column(String(100), nullable=False)
    fullname = Column(String(200), Computed("CONCAT(firstname, ' ', lastname)"))
    title = Column(String(250), nullable=True)
    ...
    actions = relationship('Action', backref='contact', lazy=True)
